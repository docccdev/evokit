...
|         Class         |         Description         |
|-----------------------|-----------------------------|
|  `.ui-grid_size_xxs`  | Отступ между ячейками 4px.  |
|  `.ui-grid_size_xs`   | Отступ между ячейками 10px. |
|  `.ui-grid_size_s`    | Отступ между ячейками 14px. |
|  `.ui-grid_size_m`    | Отступ между ячейками 20px. |
|  `.ui-grid_size_l`    | Отступ между ячейками 24px. |
|  `.ui-grid_size_xl`   | Отступ между ячейками 30px. |
|  `.ui-grid_size_xxl`  | Отступ между ячейками 34px. |
